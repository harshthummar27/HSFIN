  ...
  return (
    <div className="p-2 md:p-6" style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div className="mb-3 md:mb-6">
        <h1 className="text-lg md:text-3xl font-bold" style={{ color: '#003049' }}>Daily Debit</h1>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-2 md:px-4 py-1.5 md:py-2.5 text-xs md:text-sm border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            />
          </div>
          <div>
            <label className="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Rupees</label>
            <input
              type="number"
              step="0.01"
          ...
          <div>
            <label className="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Note</label>
            <input
              type="text"
              value={formData.note}
            ...
            <tbody className="divide-y divide-gray-200">
              {debits.map((debit) => (
                <tr key={debit._id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-gray-900">{debit.note || '-'}</td>
