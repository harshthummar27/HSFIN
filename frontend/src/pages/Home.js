...
const Home = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden relative flex flex-col" style={{ background: 'linear-gradient(135deg, #f2f4f3 0%, #e8eae9 100%)' }}>
      {/* Animated Background Circles */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none hidden md:block">
        <div className="absolute top-20 left-10 w-72 h-72 rounded-full opacity-20 animate-pulse" style={{ backgroundColor: '#49111c', animation: 'float 6s ease-in-out infinite' }}></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full opacity-15 animate-pulse" style={{ backgroundColor: '#0A0908', animation: 'float 8s ease-in-out infinite' }}></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 rounded-full opacity-10 animate-pulse" style={{ backgroundColor: '#49111c', animation: 'float 7s ease-in-out infinite' }}></div>
      </div>
      ...
      {/* Hero Section */}
      <div className="container mx-auto px-4 md:px-6 py-8 md:py-16 relative z-10 flex-1">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              {/* Badge */}
              <div className="inline-block mb-4 px-3 py-1 rounded-full text-xs font-semibold" style={{ backgroundColor: '#f2f4f3', color: '#49111c' }}>
                ✨ All-in-One Finance Solution
              </div>

              {/* Main Heading */}
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r" style={{ 
                backgroundImage: 'linear-gradient(to right, #0A0908, #49111c)',
              ...
              {/* Subtitle */}
              <p className="text-lg md:text-xl mb-4 font-semibold" style={{ color: '#49111c' }}>
              ...
              <div className="mb-6 space-y-2">
                <div className="flex items-center text-sm text-gray-700">
                  <span className="mr-2" style={{ color: '#49111c' }}>✓</span>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  style={{ borderColor: '#49111c', color: '#49111c', backgroundColor: 'transparent' }}
                  onMouseEnter={(e) => {
              ...
              <div className="mt-8 grid grid-cols-3 gap-4 pt-6 border-t" style={{ borderColor: '#e5e7eb' }}>
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold" style={{ color: '#0A0908' }}>100%</div>
                  <div className="text-xs text-gray-600 mt-1">Secure</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold" style={{ color: '#0A0908' }}>24/7</div>
                  <div className="text-xs text-gray-600 mt-1">Access</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold" style={{ color: '#0A0908' }}>Free</div>
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 p-3 rounded-lg" style={{ backgroundColor: '#f2f4f3' }}>
                      <div className="text-2xl">📊</div>
                      <div>
                        <div className="text-sm font-semibold" style={{ color: '#0A0908' }}>Dashboard Overview</div>
                    ...
                    <div className="flex items-center space-x-3 p-3 rounded-lg" style={{ backgroundColor: '#f2f4f3' }}>
                      <div className="text-2xl">💳</div>
                      <div>
                        <div className="text-sm font-semibold" style={{ color: '#0A0908' }}>Expense Tracking</div>
                    ...
                    <div className="flex items-center space-x-3 p-3 rounded-lg" style={{ backgroundColor: '#f2f4f3' }}>
                      <div className="text-2xl">📈</div>
                      <div>
                        <div className="text-sm font-semibold" style={{ color: '#0A0908' }}>Analytics & Reports</div>
                    ...
                    <div className="flex items-center space-x-3 p-3 rounded-lg" style={{ backgroundColor: '#f2f4f3' }}>
                      <div className="text-2xl">💰</div>
                      <div>
                        <div className="text-sm font-semibold" style={{ color: '#0A0908' }}>Loan Management</div>
                ...
                {/* Decorative Elements */}
                <div className="absolute -top-4 -right-4 w-20 h-20 rounded-full opacity-20" style={{ backgroundColor: '#49111c' }}></div>
                <div className="absolute -bottom-4 -left-4 w-16 h-16 rounded-full opacity-15" style={{ backgroundColor: '#0A0908' }}></div>
              </div>
            </div>
          </div>
            ...
            <div className="hidden md:grid md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <h3 className="text-xl font-bold mb-2" style={{ color: '#0A0908' }}>{feature.title}</h3>
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="bg-white p-5 rounded-xl mx-2">
                      ...
                      <h3 className="text-lg font-bold mb-2 text-center" style={{ color: '#0A0908' }}>{feature.title}</h3>
              ...
              <div className="flex justify-center mt-4 space-x-2">
                {features.map((_, index) => (
                  <button
                    ...
                    style={{ 
                      backgroundColor: currentSlide === index ? '#49111c' : '#d1d5db',
